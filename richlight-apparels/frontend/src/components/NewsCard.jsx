...
function NewsCard({ title, description, imageUrl, className = '' }) {
...
const styles = {
  ...
  imgWrap: { width: '100%', aspectRatio: '16/10', backgroundColor: 'var(--bg-elevated)', overflow: 'hidden' },
  img: { width: '100%', height: '100%', objectFit: 'cover', willChange: 'transform' },
  body: { padding: '1.25rem' },
  title: { margin: '0 0 0.5rem', fontSize: 'var(--heading-3)', fontWeight: 600, color: 'var(--text)' },
